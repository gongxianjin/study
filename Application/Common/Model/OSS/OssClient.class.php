...
use Common\Model\OSS\Core\MimeTypes;
use Common\Model\OSS\Core\OssException;
use Common\Model\OSS\Http\RequestCore;
use Common\Model\OSS\Http\RequestCore_Exception;
use Common\Model\OSS\Http\ResponseCore;
use Common\Model\OSS\Model\CorsConfig;
use Common\Model\OSS\Model\CnameConfig;
use Common\Model\OSS\Model\LoggingConfig;
use Common\Model\OSS\Model\LiveChannelConfig;
use Common\Model\OSS\Model\LiveChannelInfo;
use Common\Model\OSS\Model\LiveChannelListInfo;
use Common\Model\OSS\Result\AclResult;
use Common\Model\OSS\Result\BodyResult;
use Common\Model\OSS\Result\GetCorsResult;
use Common\Model\OSS\Result\GetLifecycleResult;
use Common\Model\OSS\Result\GetLoggingResult;
use Common\Model\OSS\Result\GetRefererResult;
use Common\Model\OSS\Result\GetWebsiteResult;
use Common\Model\OSS\Result\GetCnameResult;
use Common\Model\OSS\Result\HeaderResult;
use Common\Model\OSS\Result\InitiateMultipartUploadResult;
use Common\Model\OSS\Result\ListBucketsResult;
use Common\Model\OSS\Result\ListMultipartUploadResult;
use Common\Model\OSS\Model\ListMultipartUploadInfo;
use Common\Model\OSS\Result\ListObjectsResult;
use Common\Model\OSS\Result\ListPartsResult;
use Common\Model\OSS\Result\PutSetDeleteResult;
use Common\Model\OSS\Result\DeleteObjectsResult;
use Common\Model\OSS\Result\CopyObjectResult;
use Common\Model\OSS\Result\CallbackResult;
use Common\Model\OSS\Result\ExistResult;
use Common\Model\OSS\Result\PutLiveChannelResult;
use Common\Model\OSS\Result\GetLiveChannelHistoryResult;
use Common\Model\OSS\Result\GetLiveChannelInfoResult;
use Common\Model\OSS\Result\GetLiveChannelStatusResult;
use Common\Model\OSS\Result\ListLiveChannelResult;
use Common\Model\OSS\Result\AppendResult;
use Common\Model\OSS\Model\ObjectListInfo;
use Common\Model\OSS\Result\UploadPartResult;
use Common\Model\OSS\Model\BucketListInfo;
use Common\Model\OSS\Model\LifecycleConfig;
use Common\Model\OSS\Model\RefererConfig;
use Common\Model\OSS\Model\WebsiteConfig;
use Common\Model\OSS\Core\OssUtil;
use Common\Model\OSS\Model\ListPartsInfo;
