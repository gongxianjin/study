...
INSERT INTO `book_res` VALUES (20,1,'纯音乐 - 欢快钢琴曲','80ba191acbd9df2053275471b2e19b16.jpg','','',''),(19,1,'纯音乐 - 古筝 (王燕琴)','3ac2973e2e30c47884701dcab4c2a3d9.jpg','','',''),(18,1,'六哲 - 音乐','3ac2973e2e30c47884701dcab4c2a3d9.jpg','','',''),(17,1,'d62a6059252dd42a2a58724c093b5bb5c8eab887','3ac2973e2e30c47884701dcab4c2a3d9.jpg','','',''),(15,1,'b21c8701a18b87d609fe43f10d0828381e30fda4','c4c5dceaf449bd3011ff20ef8231b70b.jpg','','',''),(13,1,'5243fbf2b211931364524d606f380cd790238dc9','a8dca2ef0864c290d2109d76fa532b82.jpg','','',''),(14,1,'902397dda144ad34c5e9756ddaa20cf430ad8582','dc437a693a0eb267b3ab229bc746aaed.jpg','','',''),(16,1,'caef76094b36acaf29e9c61576d98d1000e99cc9','012a8bb1f653b4f2784db429e1d69f14.jpg','','',''),(12,1,'342ac65c10385343cc0a93f39913b07ecb80881e','743916afefac283f3f50b7c90691ea39.jpg','','',''),(22,1,'纯音乐 - 轻松欢快的背景音乐','3ac2973e2e30c47884701dcab4c2a3d9.jpg','','',''),(21,1,'纯音乐 - 第一轮抽奖欢快的背景音乐','3ac2973e2e30c47884701dcab4c2a3d9.jpg','','','');
/*!40000 ALTER TABLE `book_res` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `book_unit`
--

DROP TABLE IF EXISTS `book_unit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `book_unit` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `book_id` int(11) NOT NULL COMMENT '课本ID',
  `booktext_id` varchar(20) NOT NULL COMMENT '课本名称',
  `time` int(11) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='自制课本单元';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `book_unit`
--

LOCK TABLES `book_unit` WRITE;
/*!40000 ALTER TABLE `book_unit` DISABLE KEYS */;
/*!40000 ALTER TABLE `book_unit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `booktext`
--
...
CREATE TABLE `booktext` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '课文ID',
  `name` varchar(20) NOT NULL COMMENT '课文名称',
  `cover_img` varchar(50) NOT NULL COMMENT '课文封面',
  `time` int(11) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='自制课文';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `booktext`
--

LOCK TABLES `booktext` WRITE;
/*!40000 ALTER TABLE `booktext` DISABLE KEYS */;
/*!40000 ALTER TABLE `booktext` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `booktext_res`
--

DROP TABLE IF EXISTS `booktext_res`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `booktext_res` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `booktext_id` int(11) NOT NULL COMMENT '课文ID',
  `content_img` int(11) NOT NULL COMMENT '图片',
  `content_voice` varchar(20) NOT NULL COMMENT '音频',
  `time` int(11) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='课文内容';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `booktext_res`
--

LOCK TABLES `booktext_res` WRITE;
/*!40000 ALTER TABLE `booktext_res` DISABLE KEYS */;
/*!40000 ALTER TABLE `booktext_res` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-01-24 20:00:11
